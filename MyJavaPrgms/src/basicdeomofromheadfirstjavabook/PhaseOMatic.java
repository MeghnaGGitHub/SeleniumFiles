package basicdeomofromheadfirstjavabook;
...
public class PhaseOMatic {
	public static void main(String[] args) {
		...
		String[] wordListTwo = {"empowered", "sticky","value-added","oriented","centric","distributed",
				...
				"targeted","shared","co-operative","accelerated"};
		...
		System.out.println("List 1 has "+oneLength+"words collection");
		System.out.println("List 2 has "+oneLength+"words collection");
		System.out.println("List 3 has "+oneLength+"words collection");
		...
		System.out.println("What we need phrase is : " + phrase);
