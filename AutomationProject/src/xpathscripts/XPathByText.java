...
public class XPathByText {
	...
	public static void main(String[] args) {
		...
		//Also we can combine x-path by attribute & x-path by text()
		driver.findElement(By.xpath(".//span[@name='msg01' and  text()='TextMsg_03']"));//--> x-path by attribute and text() to identify 3rd Span
